package com.kkkoke.lottery.domain.activity.service.stateflow.event;

import com.kkkoke.lottery.common.Constants;
import com.kkkoke.lottery.common.Result;
import com.kkkoke.lottery.domain.activity.service.stateflow.AbstractState;
...
public class OpenState extends AbstractState {
    ...
    public Result close(Long activityId, Enum<Constants.ActivityState> currentState) {
        ...
        return isSuccess ? Result.buildResult(Constants.ResponseCode.SUCCESS, "活动关闭完成")
    ...
    public Result doing(Long activityId, Enum<Constants.ActivityState> currentState) {
        ...
        return isSuccess ? Result.buildResult(Constants.ResponseCode.SUCCESS, "活动变更活动中完成")
                : Result.buildErrorResult("活动状态变更失败");
    }
}