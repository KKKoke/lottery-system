package com.kkkoke.lottery.application.worker;
            ...
            for (ActivityVO activityVO : activityVOList) {
                ...
                switch (state) {
                    ...
                    case 4:
                        ...
                        logger.info("扫描活动状态为活动中 结果：{} activityId：{} activityName：{} creator：{}", JSON.toJSONString(state4Result),
                    ...
                    case 5:
                        if (activityVO.getEndDateTime().before(new Date())){
                            ...
                            logger.info("扫描活动状态为关闭 结果：{} activityId：{} activityName：{} creator：{}", JSON.toJSONString(state5Result),
                                    activityVO.getActivityId(), activityVO.getActivityName(), activityVO.getCreator());
                        }
                        break;
                    default:
